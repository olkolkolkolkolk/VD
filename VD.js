...
// Ajouter un div résultat sous les questions
  ...
  resultDiv.innerHTML = `<h2>Aoutch ! Au final, la question ne se pose pas : vous venez de recevoir un message. Elle n’a pas été séduite et vous envoie un message exprimant son désintérêt. Heureusement, grâce à votre superbe équipe de bibliothécaires, vous ne passerez pas votre soirée seule : un super DVD vous tiendra compagnie ! Curieux de connaître votre match ? </h2>`; 
...
function restartTest() {
  window.location.href = "index.html";  // Ou "/" selon ta structure de site
}
}
